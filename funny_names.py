"""Generates funny names by randomly combining names form 2 separate lists"""
import sys
import random
...
def main():
    ...
    print("\n\nWelcome to the Psych 'Sidekik Name Picker'.\n"
    ...
    while True:
        ...
        try_again = input('Tty again? (Pres ENTER else n to quit)\n')
